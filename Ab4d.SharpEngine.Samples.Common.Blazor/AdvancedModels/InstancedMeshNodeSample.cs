    ...
    private void ChangeMesh(int selectedIndex)
    {
        ...
        else if (selectedIndex == 2)
        {
            ...
            else
            {
                ...
                TestScenes.GetTestMesh(Scene, TestScenes.StandardTestScenes.Teapot, finalSize: new Vector3(20, 20, 20), (teapotMesh) =>
                {
        ...
        else if (selectedIndex == 3)
        {
            ...
            else
            {
                if (Scene != null)
                {
                    base.GetCommonTextureAsync("TreeTexture.png", Scene, gpuImage =>
                    {
